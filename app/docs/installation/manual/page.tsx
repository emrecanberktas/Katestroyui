...
export default function ManualInstallationPage() {
  return (
    <div className="max-w-2xl mx-auto py-10 px-4 flex flex-col gap-8">
      <h1 className="text-3xl font-bold mb-3">Manual Installation</h1>
      <p className="text-muted-foreground text-lg mb-6">
        Add dependencies and configure your project manually.
      </p>

      <h2 className="text-xl font-semibold mb-2 mt-6">Add Tailwind CSS</h2>
      <p className="mb-2">
        Components are styled using Tailwind CSS. You need to install Tailwind
        CSS in your project. Follow the Tailwind CSS installation instructions
        to get started.
      </p>

      <h2 className="text-xl font-semibold mb-2 mt-8">Add dependencies</h2>
      <TerminalBlock
        commands={{
      ...
      <p className="mb-2">
        ...
        <span className="font-mono">tsconfig.json</span> file:
      </p>
      <CodeBlock
        code={`{
  "compilerOptions": {
    ...
    "paths": {
      ...
      <p className="mb-2 text-muted-foreground text-xs">
        The <span className="font-mono">@</span> alias is a preference. You can
        use other aliases if you want.
      </p>

      <h2 className="text-xl font-semibold mb-2 mt-8">Configure styles</h2>
      <p className="mb-2">
        Add the following to your{" "}
        <span className="font-mono">styles/globals.css</span> file. You can
  ...
  * {
  ...
  body {
    @apply bg-background text-foreground;
      ...
      <h2 className="text-xl font-semibold mb-2 mt-8">Add a cn helper</h2>
      <p className="mb-2">
        Add a <span className="font-mono">cn</span> helper to{" "}
...
export function cn(...inputs: ClassValue[]) {
  return twMerge(clsx(inputs))
      ...
      <p className="mb-2">
        Create a <span className="font-mono">components.json</span> file in the
